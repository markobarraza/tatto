...
if ( ! function_exists('publicacion_post_type') ) {

// Register Custom Post Type
function publicacion_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Crea un nueva publicacion', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'publicacion_post_type', 0 );
